...
function loadTable(selectedAbteilungValue, selectedBereichValue, username) {
  console.log("aktuelleWocheOffset vor dem AJAX-Aufruf: ", aktuelleWocheOffset);
...
function submitForm(benutzerIdForms, datumAttributForms) {
